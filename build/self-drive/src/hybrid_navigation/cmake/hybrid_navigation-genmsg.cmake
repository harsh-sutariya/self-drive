...
message(STATUS "hybrid_navigation: 0 messages, 1 services")
...
get_filename_component(_filename "/home/ai4ce/team3-deploy/catkin_s25/src/self-drive/src/hybrid_navigation/srv/LoadTarget.srv" NAME_WE)
add_custom_target(_hybrid_navigation_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hybrid_navigation" "/home/ai4ce/team3-deploy/catkin_s25/src/self-drive/src/hybrid_navigation/srv/LoadTarget.srv" ""
)
...
### Generating Services
_generate_srv_cpp(hybrid_navigation
  "/home/ai4ce/team3-deploy/catkin_s25/src/self-drive/src/hybrid_navigation/srv/LoadTarget.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_eus(hybrid_navigation
  "/home/ai4ce/team3-deploy/catkin_s25/src/self-drive/src/hybrid_navigation/srv/LoadTarget.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_lisp(hybrid_navigation
  "/home/ai4ce/team3-deploy/catkin_s25/src/self-drive/src/hybrid_navigation/srv/LoadTarget.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_nodejs(hybrid_navigation
  "/home/ai4ce/team3-deploy/catkin_s25/src/self-drive/src/hybrid_navigation/srv/LoadTarget.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_py(hybrid_navigation
  "/home/ai4ce/team3-deploy/catkin_s25/src/self-drive/src/hybrid_navigation/srv/LoadTarget.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hybrid_navigation)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hybrid_navigation\")")
  # install generated code
  install(
